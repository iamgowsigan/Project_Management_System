<?php
	...
	{ 
		...
		if(isset($_POST['updatee']))
		{
			...
			$color = $_POST['p_color'];
			$delivery = $_POST['p_delivery'];
			$stock = $_POST['p_stock'];
			$stockleft = $_POST['p_stock_left'];
		...
		if(isset($_POST['submitimages']))
		{
			...
			foreach ($_FILES['files']['tmp_name'] as $key => $value) { 
				...
				$query = mysqli_query($con, "insert into product_images(p_id,pi_var,pi_image,is_bid) values('$pid','$pi_variant','$file_name','0')");
					...
					<div class="content">
						...
						<div class="container-fluid">
							...
							<div class="row" id="pos"><!-- container Start-->
								...
								<a  class="btn btn-sm btn-primary m-2" href="app-products.php"><?php mylan(" Back  ","خلف "); ?></a>
								
								<?php
									
									$query1 = mysqli_query($con, "Select * from products WHERE p_id=$pid");
										...
										<form class="form" method="post" enctype="multipart/form-data">
											<div class="card">
												<div class="ml-2 float-left">
													<h4><?php mylan("Basic ","صور المنتج "); ?></h4>
												...
												<div class="card-body">
													<div class="row">
														...
														<div class="col-6">
															<div class="form-group mb-3">
																<label for="validationCustom01"><?php mylan("Sub Title","ترجمات "); ?> </label>
																<input type="text" class="form-control" name="p_sub" value="<?=$rowp['p_sub']; ?>" required>
															</div>
														</div>
														<div class="col-6">
															<div class="form-group mb-3">
																<label for="validationCustom01"><?php mylan("Sub Title Arabic ","العنوان الفرعي عربي  "); ?> </label>
											...
											<div class="card">
												<div class="ml-2 float-left">
													<h4><?php mylan("Price & Units ","صور المنتج "); ?></h4>
												...
												<div class="card-body">
													<div class="row">
														<div class="col-6">
															<div class="form-group mb-3">
																<label for="validationCustom01">Original Price</label>
																<input type="number" class="form-control" name="p_mrp" id="p_mrp" value="<?=$rowp['p_mrp']; ?>" required>
														...
														<div class="col-6">
															<div class="form-group mb-3">
																...
																<input type="number" class="form-control" name="p_sell" id="p_sell" value="<?=$rowp['p_sell']; ?>" required>
														...
														<div class="col-6">
															<div class="form-group mb-3">
																<label for="validationCustom01"><?php mylan("Stock Count ","عدد الأسهم"); ?></label>
																<input type="text" class="form-control" name="p_stock" value="<?=$rowp['p_stock']; ?>" required>
														...
														<div class="col-6">
															<div class="form-group mb-3">
																<label for="validationCustom01"><?php mylan("Stock Left ","بقي المخزون"); ?></label>
																<input style="<?php if($rowp['p_stock_left']<0){echo 'color:red';} ?>;" type="text" class="form-control" name="p_stock_left" value="<?=$rowp['p_stock_left']; ?>" required>
											...
											<div class="card">
												<div class="ml-2 float-left">
													<h4><?php mylan("Details ","صور المنتج "); ?></h4>
														...
														<form class="pl-3 pr-3"  method="post" enctype="multipart/form-data">
															...
															<div class="col-12">
																<div class="form-group">
																	...
																	<input type="file" class="form-control-file" id="exampleInputFile" name="files[]"  accept="image/png, image/jpeg,image/webp" multiple>
																</div>
															</div>

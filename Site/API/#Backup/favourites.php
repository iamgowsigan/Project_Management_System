							...
							<div class="row">
								<div class="col-12">
									<div class="page-title-box">
										...
										<h4 class="page-title"><?=$sname;?> User Favourites</h4>
									</div>
								</div>
							</div>   
																...
																<tr>
																	<?php
																		...
																		<tr>
																			...
																			<td><?php text( $row['pl_id'], $strong=false, $small=false, $badge=false, $lighten=false, $outline=false, '' ); ?></td>
																			...
																			<td><?php action(  $row['pl_id'] ,'E,D' ); ?></td>

<?php
	...
	{ 
		...
		if(isset($_POST['update']))
		{
			...
			$field['p_product'] = addslashes($_POST['p_product']);
			$field['p_url'] = addslashes($_POST['p_url']);
			$field['pa_image'] = $file_name;
												...
												<table data-order='[[ 0, "desc" ]]' id="basic-datatable" class="table dt-responsive nowrap w-100">
													...
													<tbody>
														<?php
															...
															$listdata=Selectdata("SELECT p.*,c.* from popads p LEFT JOIN category c ON c.c_id=p.p_category");
																...
																<tr>
																	<?php
																		...
																		<tr>
																			...
																			<td><?php text( $row['c_name'], $strong=true, $small=false, $badge=false, $lighten=false, $outline=false, '' ); ?></td>
													...
													<div class="modal-body">
														...
														<form class="pl-3 pr-3"  method="post" enctype="multipart/form-data">
															<div class="row">
																...
																formselect(  'Category',  'c_name', $menudata, 'required','6', '', 'c_id', 'c_name' ); ?>
																
																<?php  
																	$menudata=Selectdata("SELECT * FROM products Order BY p_title ASC");
																formselect(  'Category',  'p_product', $menudata, 'required','6', '', 'p_id', 'p_title' ); ?>

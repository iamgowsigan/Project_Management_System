<?php
	...
	{ 
		...
		if(isset($_POST['submit']))
		{
			...
			$sql= "insert into ads(a_title,a_title_arab,a_image,a_category,a_sub,a_brand,a_product,a_min,a_max,a_type) values('$title','$titlearab','$file_name','$cid','$scid','$brand','$product','$min','$max','price')";
					...
					<div class="content">
						...
						<div class="container-fluid">
							<div class="row">
								<div class="col-12">
									<div class="page-title-box">
										...
										<h4 class="page-title"><?php mylan("Price Ads Management ","إدارة إعلانات الأسعار "); ?></h4>
									</div>
								</div>
							</div>   
							<div class="row"><!-- container Start-->
								...
								<!-- container START-->							
								<!------------------>		
								<button type="button" class="btn btn-primary m-2" data-toggle="modal" data-target="#signup-modal"><?php mylan("Add Price Ad ","إضافة إعلان السعر"); ?></button>
											...
											<table id="basic-datatable" class="table dt-responsive nowrap w-100">
												...
												<tbody>
													<?php
														...
														$query = mysqli_query($con, "SELECT * from ads WHERE a_type = 'price'");
														$cnt = 1;
													...
													<div class="modal-body">
														...
														<form class="pl-3 pr-3"  method="post" enctype="multipart/form-data">
															...
															<div class="form-group text-center">
																<button class="btn btn-primary" type="submit" name="submit"><?php mylan("Add Price Ad ","إضافة إعلان السعر "); ?></button>
															</div>

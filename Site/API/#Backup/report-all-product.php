<?php
	...
	<html lang="en">
		...
		<body class="loading" data-layout-config='{"leftSideBarTheme":"<?=$menumode;?>","layoutBoxed":false, "leftSidebarCondensed":true, "leftSidebarScrollable":false,"darkMode":<?=$bodymode;?>, "showRightSidebarOnStart": false}'>
			<div class="wrapper">		
								...
								<div class="col-lg-12">
									<div class="card">
										...
										<div class="card-body">
											...
											<table  id="datatable-buttonsss"   class="table dt-responsive w-100" data-order='[[ 0, "desc" ]]'>
												<thead>
													<tr>
														<th>ID</th>
														<th>Image</th>
																...
																<tr>
																	<?php
																		...
																		<tr>
																			...
																			<td><?php text( $row['p_title_arab'], $strong=false, $small=true, $badge=false, $lighten=false, $outline=false, '' ); ?></td>
																			<td><?php text( $row['sc_name'], $strong=false, $small=true, $badge=false, $lighten=false, $outline=false, '' ); ?></td>
																			<td><?php text( $row['sc_name_arab'], $strong=false, $small=true, $badge=false, $lighten=false, $outline=false, '' ); ?></td>
																			<td><?php text( $row['c_name'], $strong=false, $small=true, $badge=false, $lighten=false, $outline=false, '' ); ?></td>
																			<td><?php text( $row['c_name_arab'], $strong=false, $small=true, $badge=false, $lighten=false, $outline=false, '' ); ?></td>
																			<td><?php text( $row['p_mrp'].' AED', $strong=false, $small=true, $badge=false, $lighten=false, $outline=false, '' ); ?></td>
																			<td><?php text( $row['p_sell'].' AED', $strong=false, $small=true, $badge=false, $lighten=false, $outline=false, '' ); ?></td>
																			...
																			<td><?php text( $row['views'], $strong=false, $small=true, $badge=false, $lighten=false, $outline=false, '' ); ?></td>
																		
																			<td><?php text( $row['p_likes'], $strong=false, $small=true, $badge=false, $lighten=false, $outline=false, '' ); ?></td>
																			<td><?php text(rating( $row['p_rating'], $row['p_count'], $isValue=true ), $strong=false, $small=true, $badge=false, $lighten=false, $outline=false, '' ); ?></td>
																			<td><?php text( $row['p_count'], $strong=false, $small=true, $badge=false, $lighten=false, $outline=false, '' ); ?></td>

																			<td><?php 
																			$countCart=Countdata("Select * FROM cart WHERE p_id=$pid AND book_id=0");
																			text( $countCart, $strong=false, $small=true, $badge=false, $lighten=false, $outline=false, '' ); ?></td>

																			<td><?php 
																			$countBuy=Countdata("Select * FROM cart WHERE p_id=$pid AND book_id!=0");
																			text( $countBuy, $strong=false, $small=true, $badge=false, $lighten=false, $outline=false, '' ); ?></td>

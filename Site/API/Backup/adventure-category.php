	...
	{ 
       ...
       if(isset($_POST['save']))
		...
		if(isset($_POST['submit']))
		{
			...
			$query = mysqli_query($con, "insert into category(c_name, c_name_arab, c_detail, c_detail_arab, c_image,c_banner,screen ) values('$title','$titlearab','$detail','$detailarab','$file_name','$file_name2','2')");
					...
					<div class="content">
						...
						<div class="container-fluid">
							<div class="row">
								<div class="col-12">
									<div class="page-title-box">
										...
										<h4 class="page-title"><?php mylan("Adventure Category Management ","إدارة فئة المغامرة"); ?></h4>
									</div>
								</div>
							</div>   
							<div class="row"><!-- container Start-->
								...
								<button type="button" class="btn btn-primary m-2" data-toggle="modal" data-target="#signup-modal"><?php mylan("Add Adventure Category "," أضف فئة المغامرة "); ?></button>
								<div class="col-lg-12">
									<div class="card">
										<div class="card-body">
											...
											<table data-order='[[ 0, "desc" ]]' id="basic-datatable" class="table dt-responsive nowrap w-100">
												...
												<tbody>
													<?php
														...
														$query = mysqli_query($con, "Select * FROM category where screen='2'");
														$cnt = 1;

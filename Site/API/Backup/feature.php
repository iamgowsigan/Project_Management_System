	...
	{ 
       ...
       if(isset($_POST['save']))
		...
		if(isset($_POST['submit']))
		{
			...
			$query = mysqli_query($con, "insert into feature(f_name, f_name_arab, f_image,screen ) values('$title','$titlearab','$file_name','$screen')");
		...
		if ($_GET['action'] == 'del' && $_GET['scid']) {
			...
			$query = mysqli_query($con, "delete from feature where f_id='$id'");
            $msg = "Deleted ";
            $uname = $_SESSION['login'];
            $queryy = mysqli_query($con, "insert into adminlog(name,action) values('$uname','Feature deleted')");
					...
					<div class="content">
						...
						<div class="container-fluid">
									...
									<div class="page-title-box">
										<div class="page-title-right">
											<ol class="breadcrumb m-0">
												...
												<li class="breadcrumb-item active"><?php mylan("Feature ","ميزة "); ?></li>
											</ol>
										</div>
										<h4 class="page-title"><?php mylan("Feature Management ","إدارة الميزات"); ?></h4>
									</div>
								</div>
							</div>   
							<div class="row"><!-- container Start-->
								...
								<button type="button" class="btn btn-primary m-2" data-toggle="modal" data-target="#signup-modal"><?php mylan("Add Feature "," إضافة ميزة "); ?></button>
								<div class="col-lg-12">
									<div class="card">
										<div class="card-body">
											...
											<table data-order='[[ 0, "desc" ]]' id="basic-datatable" class="table dt-responsive nowrap w-100">
												...
												<tbody>
													<?php
														...
														$query = mysqli_query($con, "Select * FROM feature ");
														$cnt = 1;
														...
														<tr>
															...
															<tr>
																<?php
																	...
																	?>
																	<tr>
																		<td><?php echo htmlentities($row['f_id']); ?></td>
																		
																		<td>

																			<img src="<?php echo htmlentities($imgloc.$row['f_image']); ?>"  style="object-fit:cover;width:50px;height:50px;" class="rounded img-thumbnail" onerror="this.src='assets/images/bg-auth.jpg'">
																		</td>
																		...
																		<div class="btn-group">
																			...
																			<div class="dropdown-menu">
																				...
																				<a class="dropdown-item" href="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>?scid=<?php echo htmlentities($row['f_id']); ?>&&action=del" onclick="return confirm('Are you sure you want to delete?');"  ><?php mylan("Delete  "," حذف"); ?></a>
												...
												<div class="modal-body">
													...
													<form class="pl-3 pr-3"  method="post" enctype="multipart/form-data">
														<div class="row">
															...
															<div class="col-6">
																<div class="form-group mb-3">
																	<label for="validationCustom01"><?php mylan("Feature Name in Arabic ","اسم الميزة بالعربية"); ?> </label>
														...
														<div class="form-group text-center">
															<button class="btn btn-primary" type="submit" name="submit"><?php mylan("Add Feature ","إضافة ميزة"); ?></button>
														</div>

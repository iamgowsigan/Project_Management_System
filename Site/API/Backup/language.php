	...
	{ 
       ...
       if(isset($_POST['save']))
		...
		if(isset($_POST['submit']))
		{
			...
			$file_name = 'loc' . round(microtime(true)) . '.' . end($temp);
			...
			$query = mysqli_query($con, "insert into language(ln_name, ln_name_arab, ln_image ) values('$title','$titlearab','$file_name')");
		...
		if ($_GET['action'] == 'del' && $_GET['scid']) {
			...
			$query = mysqli_query($con, "delete from language where ln_id='$id'");
            $msg = "Deleted ";
            $uname = $_SESSION['login'];
            $queryy = mysqli_query($con, "insert into adminlog(name,action) values('$uname','Langiage deleted')");
					...
					<div class="content">
						...
						<div class="container-fluid">
							<div class="row">
								<div class="col-12">
									<div class="page-title-box">
										...
										<h4 class="page-title">Host Language Management</h4>
									</div>
								</div>
							</div>   
							<div class="row"><!-- container Start-->
								...
								<button type="button" class="btn btn-primary m-2" data-toggle="modal" data-target="#signup-modal">Add Language</button>
								<div class="col-lg-12">
									<div class="card">
										<div class="card-body">
											...
											<table data-order='[[ 0, "desc" ]]' id="basic-datatable" class="table dt-responsive nowrap w-100">
												...
												<tbody>
													<?php
														...
														$query = mysqli_query($con, "Select * FROM language");
														$cnt = 1;
														...
														<tr>
															...
															<tr>
																<?php
																	...
																	?>
																	<tr>
																		<td><?php echo htmlentities($row['ln_id']); ?></td>
																		
																		<td>

																			<img src="<?php echo htmlentities($imgloc.$row['ln_image']); ?>"  style="object-fit:cover;width:40px;height:40px;" class="rounded img-thumbnail" onerror="this.src='assets/images/bg-auth.jpg'">
																		</td>
																		
																		
																		
																				<td><?php echo htmlentities($row['ln_name']); ?></td>
																		...
																		<div class="btn-group">
																			...
																			<div class="dropdown-menu">
																				...
																				<form  method="post" enctype="multipart/form-data">
																					...
																					<input type="hidden" name="fid" value='<?=$row['ln_id']; ?>'>
																				...
																				<a class="dropdown-item" href="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>?scid=<?php echo htmlentities($row['ln_id']); ?>&&action=del" onclick="return confirm('Are you sure you want to delete?');"  ><?php mylan("Delete  "," حذف"); ?></a>
												...
												<div class="modal-body">
													...
													<form class="pl-3 pr-3"  method="post" enctype="multipart/form-data">
														<div class="row">
															...
															<div class="col-6">
																<div class="form-group mb-3">
																	<label for="validationCustom01">Title in Arab </label>
														...
														<div class="form-group text-center">
															<button class="btn btn-primary" type="submit" name="submit">Add Language</button>
														</div>

	...
	{ 
       ...
       if(isset($_POST['save']))
		...
		if(isset($_POST['submit']))
		{
			...
			$query = mysqli_query($con, "insert into location(lo_name, lo_name_arab, lo_image ) values('$title','$titlearab','$file_name')");
		...
		if ($_GET['action'] == 'del' && $_GET['scid']) {
			...
			$query = mysqli_query($con, "delete from location where lo_id='$id'");
            $msg = "Deleted ";
					...
					<div class="content">
						...
						<div class="container-fluid">
							...
							<div class="row"><!-- container Start-->
								...
								<button type="button" class="btn btn-primary m-2" data-toggle="modal" data-target="#signup-modal">Add Location</button>
								<div class="col-lg-12">
									<div class="card">
										<div class="card-body">
														...
														<tr>
															...
															<tr>
																<?php
																	...
																	?>
																	<tr>
																		<td><?php echo htmlentities($row['lo_id']); ?></td>
																		
																		<td>

																			<img src="<?php echo htmlentities($imgloc.$row['lo_image']); ?>"  style="object-fit:cover;width:50px;height:50px;" class="rounded img-thumbnail" onerror="this.src='assets/images/bg-auth.jpg'">
																		</td>
																		
																		
																		
																				<td><?php echo htmlentities($row['lo_name']); ?></td>
																		...
																		<div class="btn-group">
																			...
																			<div class="dropdown-menu">
																				...
																				<form  method="post" enctype="multipart/form-data">
																					...
																					<input type="hidden" name="fid" value='<?=$row['lo_id']; ?>'>
																				...
																				<a class="dropdown-item" href="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>?scid=<?php echo htmlentities($row['lo_id']); ?>&&action=del" onclick="return confirm('Are you sure you want to delete?');"  ><?php mylan("Delete  "," حذف"); ?></a>

       ...
       if(isset($_POST['save']))
		{
			...
			$_SESSION['sid']=$sid;
			header("location: edit-safety.php");
		...
		if(isset($_POST['submit']))
		{
			...
			$query = mysqli_query($con, "insert into safety(s_name, s_name_arab, s_image,screen ) values('$title','$titlearab','$file_name','$screen')");
			
			if ($query) {
				$ulog=$_SESSION['login'];
				$query = mysqli_query($con, "insert into adminlog(name,action) values('$ulog',$name.'Safety Added')");
		...
		if ($_GET['action'] == 'del' && $_GET['scid']) {
			...
			$query = mysqli_query($con, "delete from Safety  where s_id='$id'");
            $msg = "Deleted ";
            $uname = $_SESSION['login'];
            $queryy = mysqli_query($con, "insert into adminlog(name,action) values('$uname','Safety deleted')");
					...
					<div class="content">
						...
						<div class="container-fluid">
									...
									<div class="page-title-box">
										<div class="page-title-right">
											<ol class="breadcrumb m-0">
												...
												<li class="breadcrumb-item active"><?php mylan("Safety ","أمان "); ?></li>
											</ol>
										</div>
										<h4 class="page-title"><?php mylan("Safety Management ","إدارة السلامة"); ?></h4>
									</div>
								</div>
							</div>   
							<div class="row"><!-- container Start-->
								...
								<button type="button" class="btn btn-primary m-2" data-toggle="modal" data-target="#signup-modal"><?php mylan("Add Safety Category "," أضف فئة المغامرة "); ?></button>
								<div class="col-lg-12">
									<div class="card">
										<div class="card-body">
											...
											<table data-order='[[ 0, "desc" ]]' id="basic-datatable" class="table dt-responsive nowrap w-100">
												...
												<tbody>
													<?php
														...
														$query = mysqli_query($con, "Select * FROM safety ");
														$cnt = 1;
																...
																<?php
																	...
																	<tr>
																		...
																		<td>
																			...
																			<img src="<?php echo htmlentities($imgloc.$row['s_image']); ?>"  style="object-fit:cover;width:50px;height:50px;" class="rounded img-thumbnail" onerror="this.src='assets/images/bg-auth.jpg'">
																		</td>
																		...
																		<div class="btn-group">
																			...
																			<div class="dropdown-menu">
																				...
																				<a class="dropdown-item" href="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>?scid=<?php echo htmlentities($row['s_id']); ?>&&action=del" onclick="return confirm('Are you sure you want to delete?');"  ><?php mylan("Delete  "," حذف"); ?></a>
												...
												<div class="modal-body">
													...
													<form class="pl-3 pr-3"  method="post" enctype="multipart/form-data">
														<div class="row">
															...
															<div class="col-6">
																<div class="form-group mb-3">
																	<label for="validationCustom01"><?php mylan("Safety Name in Arabic ","إسم الأمان باللغة العربية "); ?> </label>
														...
														<div class="form-group text-center">
															<button class="btn btn-primary" type="submit" name="submit"><?php mylan("Add Safety ","أضف الأمان "); ?></button>
														</div>

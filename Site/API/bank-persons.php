								...
								<div class="page-title-box">
									<div class="page-title-right">
										<ol class="breadcrumb m-0">
											...
											<li class="breadcrumb-item active">Bank Persons</li>
										</ol>
									</div>
									<h4 class="page-title">Manage Bank Persons</h4>
								</div>
							</div>
						</div>
						...
						<!-- container START-->
										...
										<div class="card-body">
											<table data-order='[[ 0, "desc" ]]' id="basic-datatable"
												...
												<tbody>
													...
													$listdata = Selectdata("Select * FROM user WHERE expert = 0");
													...
													if (sizeof($listdata) == 0) {
														...
														foreach ($listdata as $row) {
															...
															<tr>
																...
																<td>
																	<?php action($row['u_id'], 'E,D', $name = $row['name']); ?>
																</td>
							...
							<?php if ($edit == 1) { ?>
								...
								<div class="col-lg-12">
									...
									<?php
									$listdata = Selectdata("Select * FROM user WHERE expert = 0 AND u_id=$eid");
									foreach ($listdata as $row) {
										?>
												...
												<div class="card">
													<div class="card-body">
														...
														<div class="row">
															...
															<?php formselect('Expert', 'expert', $expertLevel, 'required', '6', $row['expert'], 'id', 'lable'); ?>

<?php
	...
	if(strcmp($AppKey,$key)==0){
		...
		mysqli_query($conn,"UPDATE occasion SET o_view=o_view+1 WHERE o_id=$id");
		...
		$sql = "SELECT * FROM occasion WHERE o_id=$id";
		...
		echo json_encode(['success' => true, 'post' => $post,'media' => $media,'reviews'=>$reviews,'likes'=>$countLike   ]);
		...
		echo json_encode(['success' => false, 'post' => $post,'media' => $media, 'reviews'=>$reviews,'likes'=>$countLike  ]);
